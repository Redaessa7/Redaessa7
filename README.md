<div align="center">
    <img src="https://readme-typing-svg.herokuapp.com/?font=Righteous&size=35&center=true&vCenter=true&width=900&height=90&duration=4000&color=8065ca&lines=Hi+There!+👋;+I'm+Reda+Essa!+🍉;+.NET+Backend+Developer+from+Egypt" />
</div>
...
Passionate **Backend Developer** specialized in building scalable, secure, and high-performance systems using **.NET (C#)**.
...
- **Botify**  
  SaaS platform for merchants to manage orders via Telegram & WhatsApp bots with a full merchant dashboard.  
  *Tech*: ASP.NET Core • Docker • GitHub Actions

- **StronglyTypedIds**  
  NuGet package that generates type-safe, immutable IDs using Roslyn Source Generators to avoid Primitive Obsession.  
  *Tech*: C# • Roslyn Source Generators • EF Core

- **Muqabalati (مقابلتي)**  
  AI-powered job interview simulator with support for multiple Arabic dialects.  
  *Tech*: ASP.NET Core • Generative AI • Clean Architecture

- **Drosy Web API**  
  Educational management system for students, attendance, and financial tracking.  
  *Tech*: ASP.NET Core • SQL Server • Clean Architecture • Testing

- **Law Office Management**  
  Complete system for client & case management with document handling and role-based access.  
  *Tech*: ASP.NET Core • Angular • Docker • CI/CD
